...
class AutowareInitializer(Node):
    ...
    def publish_target_goal(self):
        ...
        goal_msg.pose.position.x = 3.693099021911621
        goal_msg.pose.position.y = -27.553110122680664
        goal_msg.pose.position.z = 0.0
        goal_msg.pose.orientation.x = 0.0
        goal_msg.pose.orientation.y = 0.0
        goal_msg.pose.orientation.z = -0.015619327661776462
        goal_msg.pose.orientation.w = 0.999878010861022
