...
class FollowLeadingVehicleTest(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(FollowLeadingVehicleTest, self).__init__("FollowVehicleTest",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
...
class FollowLeadingVehicleWithObstacleTest(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True):
        ...
        super(FollowLeadingVehicleWithObstacleTest, self).__init__("FollowLeadingVehicleWithObstacleTest",
                                                               ego_vehicles,
                                                               config,
                                                               world,
                                                               debug_mode,
